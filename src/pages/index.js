...
export default function Home() {
  ...
  return (
    <div className={'h-[92vh] text-black bg-white transition-all ' + inter.className}>
      <div className='fixed z-10 flex justify-between w-full px-4 py-1 bg-white sm:py-2'>
      ...
      <div id='hero-section' className='flex flex-col justify-center h-[80vh] sm:h-screen bg-white bg-top md:bg-top md:bg-hero bg-hero-mobile top-10'>
        ...
        <div>
          <button onClick={() => document.getElementById("antes-e-depois").scrollIntoView({behavior: 'smooth'})} className='p-2 px-8 font-bold text-white transition-all bg-gray-900 rounded-md hover:bg-gray-500 hover:scale-110'>CONHEÇA NOSSOS PROJETOS</button>
        </div>
        </div>
      </div>
